...
WITH temp_incomes AS (
    SELECT university_type,
        ...
        `range`,
        rate
    FROM social_dataset.jasso_gakuseiseikatsu_stats_annual_income_divide_university
    WHERE sex = '平均'
),
cum_rates AS (
    SELECT university_type,
...
SELECT divide_1st.university_type,
    divide_1st.year,
...
FROM divide_1st
    INNER JOIN divide_2nd ON divide_1st.university_type = divide_2nd.university_type
    AND divide_1st.year = divide_2nd.year
    INNER JOIN divide_3rd ON divide_1st.university_type = divide_3rd.university_type
    AND divide_1st.year = divide_3rd.year
    INNER JOIN divide_4th ON divide_1st.university_type = divide_4th.university_type
    AND divide_1st.year = divide_4th.year
    INNER JOIN divide_5th ON divide_1st.university_type = divide_5th.university_type
